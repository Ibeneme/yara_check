          ...
          <Card>
            ...
            <CardContent className="prose max-w-none">
              <div className="space-y-6">
                <section>
                  <h2 className="text-2xl font-semibold text-yaracheck-blue mb-3">
                    What Are Cookies
                  </h2>
                ...
                <section>
                  ...
                  <p className="text-slate-700">
                    YaraCheck uses cookies to enhance your experience on our
                    platform. We use cookies for the following purposes:
                  </p>
                ...
                <section>
                  ...
                  <div className="space-y-4">
                    <div>
                      <h3 className="text-lg font-medium text-yaracheck-blue">
                        Essential Cookies
                      </h3>
                      <p className="text-slate-700">
                    ...
                    <div>
                      ...
                      <p className="text-slate-700">
                        ...
                        website, such as which pages you visit most often, to
                        help us optimize performance.
                      </p>
                    </div>
                  </div>
                </section>
                ...
                <section>
                  ...
                  <p className="text-slate-700">
                    We may also use third-party services that set cookies on
                    your device. These include:
                  </p>
                  <ul className="list-disc pl-6 space-y-1 text-slate-700">
                    <li>
                      Payment processors (Stripe, Paystack, Flutterwave) for
                      secure payment processing
                    </li>
                    <li>
                      Authentication services (Supabase) for user login and
                      security
                    </li>
                    <li>
                      Analytics services to understand user behavior and improve
                      our platform
                    </li>
                    <li>
                      Social media platforms (Facebook, Twitter, YouTube) for
                      content sharing
                    </li>
                    <li>
                      Content delivery networks for improved performance and
                      global access
                    </li>
                    <li>
                      Language detection services for automatic localization
                    </li>
                  </ul>
                </section>
                ...
                <section>
                  ...
                  <p className="text-slate-700">
                    ...
                    work properly, and you may need to re-enter information more
                    frequently.
                  </p>
                </section>
