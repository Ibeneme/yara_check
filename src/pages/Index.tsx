            ...
            <div className="max-w-4xl mx-auto text-center px-4">
              ...
              <div className="text-lg sm:text-xl space-y-4 mb-8">
                <p className="font-semibold text-xl sm:text-2xl">
                  WORLD'S MOST RELIABLE PLATFORM FOR REPORTING AND TRACKING:
                </p>
                ...
                <div className="space-y-3 text-left max-w-2xl mx-auto">
                  ...
                  <p className="flex items-center">
                    <span className="mr-3">🔐</span>
                    <span>
                      Hacked or Compromised Social Media & Email Accounts
                    </span>
                  </p>
                  <p className="flex items-center">
                    <span className="mr-3">💼</span>
                    <span>Business Disputes, Scams and Fraud</span>
                  </p>
                </div>
              ...
              <div className="flex flex-col sm:flex-row justify-center gap-4">
                <Button
                  asChild
                  size="lg"
                  className="bg-yaracheck-orange hover:bg-amber-600 text-white w-full sm:w-auto"
                >
                ...
                <Button
                  ...
                  size="lg"
                  variant="outline"
                  className="bg-white text-yaracheck-blue hover:bg-gray-100 w-full sm:w-auto"
                >
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6 sm:gap-8 px-4">
              <Card className="border-t-4 border-t-yaracheck-blue shadow-md">
                <CardContent className="pt-6 text-center">
                  ...
                  <p className="text-yaracheck-darkGray">
                    Submit details of your stolen item or missing person or
                    hacked social media account. Each report generates a unique
                    tracking code after a small one-time fee.
                  </p>
                </CardContent>
              </Card>
              ...
              <Card className="border-t-4 border-t-yaracheck-orange shadow-md">
                <CardContent className="pt-6 text-center">
                  ...
                  <p className="text-yaracheck-darkGray">
                    Before purchasing any used item, check if it has been
                    reported stolen by entering its IMEI, serial number, or
                    chassis number.
                  </p>
                </CardContent>
              </Card>
              ...
              <Card className="border-t-4 border-t-green-500 shadow-md">
                <CardContent className="pt-6 text-center">
                  ...
                  <p className="text-yaracheck-darkGray">
                    Send anonymous tips on reported items or persons. Track
                    updates on your report and mark as resolved when recovered.
                  </p>
                </CardContent>
              </Card>
            </div>
              ...
              <div className="space-y-6">
                <div className="flex items-start space-x-4">
                  ...
                  <div>
                    ...
                    <p className="text-yaracheck-darkGray">
                      Our platform allows you to verify any item before
                      purchase, protecting you from buying stolen goods.
                    </p>
                  </div>
                </div>
                ...
                <div className="flex items-start space-x-4">
                  ...
                  <div>
                    ...
                    <p className="text-yaracheck-darkGray">
                      Submit anonymous tips or sightings on reported items or
                      missing persons without revealing your identity.
                    </p>
                  </div>
                </div>
                ...
                <div className="flex items-start space-x-4">
                  ...
                  <div>
                    ...
                    <p className="text-yaracheck-darkGray">
                      Each report comes with a unique tracking code allowing you
                      to follow progress and receive updates.
                    </p>
                  </div>
                </div>
                ...
                <div className="flex items-start space-x-4">
                  ...
                  <div>
                    ...
                    <p className="text-yaracheck-darkGray">
                      Our platform covers every country, helping people track
                      and find their belongings across the world.
                    </p>
                  </div>
                </div>
              </div>
        ...
        <section className="bg-yaracheck-blue py-12 sm:py-16 text-white">
          <div className="yaracheck-container text-center px-4">
            <h2 className="text-2xl sm:text-3xl font-bold mb-4 sm:mb-6">
              "Before You Buy It, YaraCheck It."
            </h2>
            <p className="text-lg sm:text-xl mb-6 sm:mb-8 max-w-2xl mx-auto">
              Don't risk purchasing stolen property. Verify first and protect
              yourself and your community. Have you lost an item? Flag it
              quickly and increase your chances of finding it! Is your social
              media account compromised?  YaraCheck it to stop further damage!
            </p>
            <Button
              asChild
              size="lg"
