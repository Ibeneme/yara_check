...
const PaymentConfirmation = () => {
  ...
  useEffect(() => {
    const setupReportDetails = async () => {
      ...
      console.log(
        "[PAYMENT-CONFIRMATION] Setting up report details for tracking code:",
        trackingCode
      );
      ...
      try {
        ...
        console.error(
          "[PAYMENT-CONFIRMATION] Error fetching report details:",
          error
        );
            ...
            <Card>
              <CardContent className="p-8">
                ...
                <p className="text-slate-600 mb-6">
                  Payment successful but no tracking code found. Please contact
                  support for assistance with your order details.
                </p>
                <Button
                  asChild
              ...
              {loading ? (
                <>
                  ...
                  <p className="text-slate-600">
                    Please wait while we retrieve your payment and report
                    details.
                  </p>
                </>
              ) : (
                <>
                  ...
                  <p className="text-slate-600 mb-8">
                    Your payment was successful and your report has been
                    submitted. Your unique tracking code is:
                  </p>

                  <div className="bg-blue-50 border border-blue-200 rounded-lg p-6 mb-8">
                    <h2 className="text-lg font-semibold text-yaracheck-blue mb-3">
                      Your Tracking Code
                    </h2>
                    <div className="flex items-center justify-center gap-3">
                      <div className="bg-white text-yaracheck-blue text-xl font-mono font-bold py-3 px-6 rounded-md border border-blue-300 break-all">
                        {trackingCode}
                      </div>
                      <Button
                        variant="outline"
                    ...
                    <p className="text-yaracheck-blue text-sm mt-3">
                      Save this code safely - you'll need it to track your
                      report
                    </p>
                  </div>
                  ...
                  <div className="space-y-4">
                    <div className="text-left bg-gray-50 rounded-lg p-4">
                      ...
                      <ul className="text-sm text-slate-600 space-y-1">
                        ...
                        <li>
                          • People can search and verify items using our system
                        </li>
