        ...
        <div className="flex items-center justify-center min-h-[80vh]">
          <Card className="w-full max-w-md mx-4">
            <CardContent className="flex flex-col items-center justify-center p-8 space-y-4">
              <Loader2 className="h-12 w-12 animate-spin text-yaracheck-blue" />
              ...
              {verificationStatus === "success" ? (
                <div className="text-center space-y-4">
                  <p className="text-lg text-slate-600">
                    Your payment has been processed successfully via
                    Flutterwave.
                  </p>
                  ...
                  <div className="bg-green-50 p-4 rounded-lg border border-green-200">
                    ...
                    <p className="text-green-700">
                      Your {reportType} report has been submitted and is being
                      processed.
                    </p>
                    ...
                    <div className="mt-4 p-3 bg-white rounded border">
                      ...
                      <div className="text-sm text-slate-600 space-y-1">
                        ...
                        <p>
                          • Date & Time Submitted: {new Date().toLocaleString()}
                        </p>
                        <p>
                          • Payment Method:{" "}
                    ...
                    <Button
                      onClick={() => {
                        ...
                        if (window.opener) {
                          ...
                          navigate(
                            `/payment-confirmation?code=${trackingCode}`
                          );
                        }
                      }}
