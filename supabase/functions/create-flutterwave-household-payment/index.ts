...
serve(async (req) => {
    ...
    try {
        ...
        console.log("Creating Flutterwave household payment:", { amount, trackingCode });
        ...
        const paymentReference = `FLW_HOUSEHOLD_${Date.now()}_${Math.random().toString(36).substring(7)}`;
        ...
        const flutterwavePayload = {
            ...
            customizations: {
                title: "Household Item Report",
                description: `Payment for household item report - ${reportData.brand} ${reportData.model}`,
                logo: ""
            }
        };
        ...
        console.error("Flutterwave household payment error:", error);
        return new Response(
