-- Update the search_by_tracking_code function to search by tracking_code field instead of ID
...
BEGIN
  ...
  WHERE d.tracking_code = tracking_code;
  ...
  WHERE v.tracking_code = tracking_code;
  ...
  WHERE h.tracking_code = tracking_code;
  ...
  WHERE pb.tracking_code = tracking_code;
  ...
  WHERE ha.tracking_code = tracking_code;
  ...
  WHERE brr.tracking_code = tracking_code;
END;
$function$;